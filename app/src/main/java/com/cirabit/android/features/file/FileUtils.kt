package com.cirabit.android.features.file
...
object FileUtils {
    ...
    /**
     * Classify CirabitMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.cirabit.android.model.CirabitMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.cirabit.android.model.CirabitMessageType.Image
            lower.startsWith("audio/") -> com.cirabit.android.model.CirabitMessageType.Audio
            else -> com.cirabit.android.model.CirabitMessageType.File
        }
    }
