...
class DataManager(private val context: Context) {
    ...
    private val prefs: SharedPreferences = context.getSharedPreferences("cirabit_prefs", Context.MODE_PRIVATE)
    ...
    fun loadChannelData(): Pair<Set<String>, Set<String>> {
        ...
        try {
            ...
            val creatorsMap: Map<String, String>? = gson.fromJson(creatorsJson, creatorsType)
