...
import com.cirabit.android.core.ui.component.button.CloseButton
                ...
                LazyColumn(
                    ...
                    item(key = "appearance") {
                        Column(modifier = Modifier.padding(horizontal = 20.dp)) {
                            ...
                            val themePref by com.cirabit.android.ui.theme.ThemePreferenceManager.themeFlow.collectAsState()
                            Surface(
                                modifier = Modifier.fillMaxWidth(),
                                color = colorScheme.surface,
                                shape = RoundedCornerShape(16.dp)
                                ...
                                Row(
                                    ...
                                    ThemeChip(
                                        ...
                                        onClick = { com.cirabit.android.ui.theme.ThemePreferenceManager.set(context, com.cirabit.android.ui.theme.ThemePreference.System) },
                                        modifier = Modifier.weight(1f)
                                    )
                                    ThemeChip(
                                        label = stringResource(R.string.about_light),
                                        selected = themePref.isLight,
                                        onClick = { com.cirabit.android.ui.theme.ThemePreferenceManager.set(context, com.cirabit.android.ui.theme.ThemePreference.Light) },
                                        modifier = Modifier.weight(1f)
                                    )
                                    ThemeChip(
                                        label = stringResource(R.string.about_dark),
                                        selected = themePref.isDark,
                                        onClick = { com.cirabit.android.ui.theme.ThemePreferenceManager.set(context, com.cirabit.android.ui.theme.ThemePreference.Dark) },
                                        modifier = Modifier.weight(1f)
                                    )
                                }
                            }
                                ...
                                Column {
                                    ...
                                    SettingsToggleRow(
                                        ...
                                        onCheckedChange = { enabled ->
                                            ...
                                            com.cirabit.android.service.MeshServicePreferences.setBackgroundEnabled(enabled)
                                            if (!enabled) {
                                                com.cirabit.android.service.MeshForegroundService.stop(context)
                                            } else {
                                                com.cirabit.android.service.MeshForegroundService.start(context)
                                            }
                                        }
                                    )
