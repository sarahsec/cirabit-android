...
class BinaryProtocolTest {
     ...
     * anything it can't parse as a valid CirabitPacket.
     */
    @Test
    ...
    private fun roundTrip(packet: CirabitPacket): CirabitPacket {
    ...
    private fun assertPacketEquals(expected: CirabitPacket, actual: CirabitPacket) {
